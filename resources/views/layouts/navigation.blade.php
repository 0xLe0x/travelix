        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('buy-token')" :active="request()->routeIs('buy-token')">
                        {{ __('Buy Token') }}
                    </x-nav-link>
                    <x-nav-link :href="route('transactions')" :active="request()->routeIs('transactions')">
                        {{ __('Transactions') }}
                    </x-nav-link>   
                    <x-nav-link :href="route('my-token')" :active="request()->routeIs('my-token')">
                        {{ __('My Token') }}
                    </x-nav-link> 
                </div>
            </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <x-responsive-nav-link :href="route('buy-token')" :active="request()->routeIs('buy-token')">
                            {{ __('Buy Token') }}
                        </x-responsive-nav-link>
                        <x-responsive-nav-link :href="route('transactions')" :active="request()->routeIs('transactions')">
                            {{ __('Transactions') }}
                        </x-responsive-nav-link>   
                        <x-responsive-nav-link :href="route('my-token')" :active="request()->routeIs('my-token')">
                            {{ __('My Token') }}
                        </x-responsive-nav-link>     -->
                        <!-- Authentication -->
